...
const guides = {
  ...
  '动漫像素':'明显的日系动漫角色像素画风，保留原图人物数量、身份特征、脸型、发型、发色、表情、姿势和服装；使用自然的动漫脸型、清晰的大眼睛、黑色瞳孔和明显高光、可辨的眉毛鼻子嘴巴，不能只是照片的块状简化。发丝必须分组，脸部使用清晰轮廓和多层阴影，配色明快、线稿干净、像经典日系像素角色立绘。不要写实照片感、油画感、3D渲染、塑料质感或无五官的平面脸。',
