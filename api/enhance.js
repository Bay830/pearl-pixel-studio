...
const guides = {
  ...
  '动漫像素':'参考经典日系动漫像素角色立绘：像素边缘清楚、深色轮廓、明快饱和配色、分组发丝、动漫脸型、清晰的大眼睛和瞳孔高光、可辨的眉毛鼻子嘴巴。保留原图人物的身份特征、发型、发色、表情、姿势、服装、手势、道具和画面关系；原图中的牌子、文字区域、背包和背景灯光等重要元素要保留为像素化的大色块。保持原图半身或全身取景，不要把人物裁成头像。整体效果应像参考图一样是有明确角色设计的动漫像素画，而不是照片的简单马赛克。不要写实照片感、油画感、3D渲染、塑料质感、无五官平面脸、随机新增人物或改变道具。',
