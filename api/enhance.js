...
const guides = {
  ...
  '动漫像素':'第一步只生成清晰的日系动漫插画原图，第二步由网站转换为拼豆图纸；不要在这一步生成网格、色号或粗糙马赛克。以输入原图为唯一构图和内容依据，严格保留人物的头部位置、身体比例、全身取景、姿势、手势、服装、背包、手中牌子、气球和背景关系，不要变成头像，不要补出原图没有的身体，不要把一个人物拆成两个人。画面要像高质量日系动漫角色插画：清晰大眼睛、瞳孔高光、眉毛、鼻子、嘴巴、分组发丝、干净深色线稿、明快饱和配色、自然脸部阴影，人物和道具边界清楚。牌子、文字区域、服装细节和背景灯光要保留为清晰的大形状，文字无法准确重现时也不要用乱码替代。目标是先得到一张构图准确、五官完整、人物可辨认的动漫图，再交给拼豆转换器处理。禁止写实照片感、油画感、3D渲染、塑料质感、无五官平面脸、随机新增人物、重复主体、分屏、裁切和改变道具。',
